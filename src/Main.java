...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Method invocation - startEngine:");
            startEngineMethod.invoke(carInstance);

            System.out.println("Method invocation - getDriver: " + getDriverMethod.invoke(carInstance) + "\n");
            System.out.println("Method invocation - getPlateNumber: " + getPlateNumberMethod.invoke(carInstance) + "\n");
            System.out.println("Method invocation - getMake: " + getMakeMethod.invoke(carInstance) + "\n");
            ...
            System.out.println("Car Methods including inherited from Object: \n"
